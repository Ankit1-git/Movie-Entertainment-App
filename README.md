...
Welcome to our Entertainment Movie Application! This  Group project was developed as part of our final module at Almabetter. It allows users to discover and explore a wide range of movies, including popular titles, upcoming releases, and personalized recommendations.
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/Ankit1-git/Movie-Entertainment-App
